...
// GetInitParameters of this Org
func (tr *Org) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Org
func (tr *Org) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
